...
<c:if test="${not empty employer and not empty document.employer}">
  <ul id="actions" class="box-general bullet-points">
      <li class="title"><fmt:message key="jobs.detail.actions"/></li>
      <li class="link"><a href="<hst:link siteMapItemRefId="jobFacets"/>/${employer}/${document.employer}"><fmt:message key="jobs.detail.allemployerjobs"/></a></li>
  </ul>
</c:if>
